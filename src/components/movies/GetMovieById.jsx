...
function GetMovieById() {
    ...
    const getChairsBySalleId = async (salleId) => {
    ...
    const handleChairClick = (chair) => {
        if (chair.available) {
            console.log('Chair is available:', chair);
            // You can proceed with a specific action here
        } else {
            console.log('Sorry, this chair is not available.');
        }
    };
    ...
    return (
        <section className="bg-teal-600 min-h-screen">
            ...
            <div className="container mx-auto px-4 py-8">
                <div>
                    <h1 className="text-3xl font-bold text-center m-5">Séance du film
                ...
                <div className="bg-white shadow-lg rounded-lg p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {seances.length > 0 ? (
                            seances.map((seance) => (
                                <div key={seance._id} className="bg-gray-100 rounded-lg p-4 shadow-md transition-transform transform hover:scale-105">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div>
                                            <Button
                                                onClick={() => getChairsBySalleId(seance.salleId._id)}
            ...
            {showModal ? (
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white shadow-2xl rounded-lg p-8 max-w-md w-full transform transition-transform duration-300 scale-100">
